...
4) Factor Analysis_What influences love at first sight.html⠀⠀⠀(RStudio)    
...
5) Linear Regression models test_Life Satisfaction prediction.html⠀⠀⠀(RStudio)         
...
6) Logistic Regression model_Trust analysis.html⠀⠀⠀(RStudio)
